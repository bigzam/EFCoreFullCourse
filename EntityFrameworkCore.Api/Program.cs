...
// => dotnet ef migrations add initial --startup-project ./EntityFrameworkCore.Console
// --project ./EntityFrameworkCore.Data
// --context FootballLeagueDbContext

// apply db changes
// =>update-database -context FootballLeagueDbContext
// => dotnet ef database update --startup-project ./EntityFrameworkCore.Console
// --project ./EntityFrameworkCore.Data
// --context FootballLeagueDbContext
...
// =>dotnet ef migrations script --startup-project ./EntityFrameworkCore.Console
// --project ./EntityFrameworkCore.Data
// --context FootballLeagueDbContext
// => dotnet ef migrations list
// => dotnet ef migrations bundle (--self-contained -r linux64) --force
...
var path = "C:\\src\\EntityFrameworkCoreFullTour";// Environment.GetFolderPath(folder);
