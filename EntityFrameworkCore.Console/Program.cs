...
var folder = "C:\\src\\EntityFrameworkCoreFullTour";// Environment.SpecialFolder.LocalApplicationData;
//var path = Environment.GetFolderPath(folder!);
var dbPath = Path.Combine(folder, "db.db");
...
void GlobalQueryFilters()
{
    ...
    //context.Leagues.AsNoTracking(); - do not track data - works faster
   // context.Coaches.IgnoreQueryFilters(); // ignore global filters 
